...
export default class makeChart {
  constructor(opts) {
    ...
    this.xVals = this.size == "mobile" ? [this.parser("2020-04-01"),this.parser("2020-07-01"), this.parser("2020-10-01"), this.parser("2021-01-01")] : [this.parser("2020-03-01"),this.parser("2020-05-01"), this.parser("2020-07-01"), this.parser("2020-09-01"), this.parser("2020-11-01"), this.parser("2021-01-01"), this.parser("2021-03-01")];
  ...
  appendElements() {
    ...
    let yearVals = this.size == "desktop" ? [this.xVals[0], this.xVals[this.xVals.length-2]] : [this.xVals[0], this.xVals[this.xVals.length-1]];
